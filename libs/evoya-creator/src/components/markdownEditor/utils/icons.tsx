...
const evoyaSvgIcons = {
  ...
  'filePlus': (
    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export type IconKey = DefaultIconKey | 'handPointer' | 'save' | 'filePlus';
